...
public class AdminController {
	...
	public String selecetmember (PageVO pageVO) throws Exception {
		//jsp의 검색시 serch_type, serarch_keywoard 내용이 PageVO클래스에 Set됩니다.
		logger.info("디버그"+ pageVO.toString());//지금까지 jsp -> 컨트롤러 일방향 자료이동.
		//위에서 검색어를 받아서 역방향 검색한 결과를jsp보내줍니다.(아래)
