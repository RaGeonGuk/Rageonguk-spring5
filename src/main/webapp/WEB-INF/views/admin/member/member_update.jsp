              ...
              <form name="form_write" action="/admin/member/member_update" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <!-- 암호는 기존값이 필요없음. 이유는 값이 있으면 업데이트 진행, 없으면, 업데이트 제외  -->
                    <input value="" name="user_pw" type="password" class="form-control" id="user_pw" placeholder="암호를 입력해주세요.">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input value="${memberVO.email }" name="email" type="text" class="form-control" id="email" placeholder="이메일을 입력해주세요.">
                  </div>
                  <div class="form-group">
                    <label for="point">포인트</label>
                    <input value="${memberVO.point }" name="point" type="number" class="form-control" id="point" placeholder="포인트를 입력해주세요.">
                  </div>
                  <div class="form-group">
                    <label for="enabled">로그인 여부</label>
                    <select name="enabled" id="enabled" class="form-control float-left">
                  ...
                  <div class="form-group">
                    ...
                    <select name="levels" id="levels" class="form-control float-left">
...
<!-- 관리자단은  jQuery 코어가 하단 footer에 있기 때문에 여기에 위치합니다. -->
<script>
$(document).ready(function(){
	...
	$("#btn_list").click(function(){
		/* 폼을 get 방식으로 전송시 암호와 같은 정보가 URL쿼리 스트링에 노출되어서 주석처리 
